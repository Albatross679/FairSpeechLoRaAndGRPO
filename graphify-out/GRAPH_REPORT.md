# Graph Report - FairSpeechLoRaAndGRPO  (2026-04-30)

## Corpus Check
- 57 files · ~233,255 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1083 nodes · 2136 edges · 53 communities detected
- Extraction: 72% EXTRACTED · 28% INFERRED · 0% AMBIGUOUS · INFERRED: 593 edges (avg confidence: 0.61)
...
Cohesion: 0.02
Nodes (162): Dataset, Sampler, _make_manifest_csv(), _manifest_rows(), Phase 1 (1.0 + 1.1) Nyquist validation tests.  Tests exercise code-level logic W, DATA-02: collate_fn pads audio to batch-max length, returns correct shapes., Padded tensor width equals the longest sample in the batch., Padded positions contain zeros (silence). (+154 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (81): check_cv_manifest(), discover_speaker_column(), main(), parse_args(), print_distribution_stats(), Print per-axis demographic distribution comparison (train% vs eval%)., Verify Common Voice test manifest exists and print accent distribution., Discover the speaker/participant ID column from Fair-Speech metadata TSV.      T (+73 more)
...
Cohesion: 0.05
Nodes (59): bootstrap_ratio_ci(), ci_overlap(), classify_insertions(), compute_bootstrap_group_ci(), compute_ci_overlap_table(), compute_fairness_table(), compute_group_table(), compute_paired_delta() (+51 more)

### Community 4 - "Community 4"
Cohesion: 0.07
Nodes (42): lambda_already_done(), load_existing_results(), main(), Full-scale GRPO lambda sweep orchestrator (Phase 5).  Iterates over a configurab, Load sweep results already on disk (for --resume)., Check if a lambda value has a completed training summary., Run full-scale GRPO training for each lambda value sequentially., run_lambda_sweep() (+34 more)
...
Cohesion: 0.11
Nodes (25): EnglishTextNormalizer, Lightweight fallback so registry/tools import without Whisper installed., check_adapter_roundtrip(), check_loss_trend(), check_transcription_quality(), check_vram(), load_adapter_model(), load_base_model_and_processor() (+17 more)
...
## Knowledge Gaps
- **233 isolated node(s):** `Phase 2 (02-standard-lora-baseline-evaluation-bridge) Nyquist validation tests.`, `Validate HP sweep outputs from 20 Optuna trials.`, `Validate train_standard_lora.py code structure without execution.`, `Validate medium-scale validation results and locked config.`, `Validate trained LoRA adapter files.` (+228 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 25`** (3 nodes): `clean_coraal_text()`, `Normalize CORAAL sociolinguistic conventions for baseline WER computation.`, `prepare_h1_datasets.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 27`** (2 nodes): `Prepare LibriSpeech test-clean manifest for ASR fairness evaluation.  Loads from`, `prepare_librispeech.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 29`** (1 nodes): `Fair-Speech manifest should have speaker_id for disjoint splits.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 32`** (1 nodes): `Convert a free-form condition label to a filename-safe suffix.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 33`** (1 nodes): `Yield (batch_df, row_positions, batch_id) using fixed or planned batches.      B`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 34`** (1 nodes): `Lightweight fallback so registry/tools import without Whisper installed.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 35`** (1 nodes): `Normalize text for WER using Whisper's English normalizer.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 36`** (1 nodes): `Writes full result rows to the output CSV incrementally during inference.      T`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 37`** (1 nodes): `Convert a raw prediction dict to a full result row.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 38`** (1 nodes): `Write a batch of predictions to CSV. Called after each inference batch.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 39`** (1 nodes): `Load audio file, resample to target sr, return numpy array.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 40`** (1 nodes): `Load wav2vec2 model and processor.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 41`** (1 nodes): `CTC-based inference with wav2vec2.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 42`** (1 nodes): `CTC-based inference with wav2vec2 (legacy single-call interface).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 43`** (1 nodes): `Load Whisper model and processor.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 44`** (1 nodes): `Encoder-decoder inference with Whisper.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 45`** (1 nodes): `Whisper inference (legacy single-call interface).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 46`** (1 nodes): `Load Qwen3-ASR model.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 47`** (1 nodes): `LLM-based inference with Qwen3-ASR via qwen-asr package.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 48`** (1 nodes): `Qwen3-ASR inference (legacy single-call interface).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 49`** (1 nodes): `Extract the actual transcription from Granite's potentially chatty output.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 50`** (1 nodes): `Load Granite-Speech model and processor.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 51`** (1 nodes): `LLM-based inference with Granite-Speech.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 52`** (1 nodes): `Granite inference (legacy single-call interface).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 53`** (1 nodes): `SALM-based inference with Canary-Qwen-2.5B (FastConformer + Qwen3 LoRA).`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 54`** (1 nodes): `Normalize reference text using Whisper if available, otherwise a light fallback.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 55`** (1 nodes): `Read WAV header metadata with the stdlib wave module.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 56`** (1 nodes): `Create one derived WAV. Returns status: created/skipped/dry-run.`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `read_csv()` connect `Community 1` to `Community 0`, `Community 2`, `Community 3`, `Community 5`, `Community 7`, `Community 11`, `Community 12`, `Community 13`, `Community 15`, `Community 16`, `Community 17`, `Community 19`, `Community 21`?**
  _High betweenness centrality (0.403) - this node is a cross-community bridge._
- **Why does `parse_args()` connect `Community 1` to `Community 0`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 9`, `Community 15`, `Community 16`, `Community 21`, `Community 22`?**
